...
This repository has my solutions to all the koans(https://www.rubykoans.com) that help in understanding the basic syntax and concepts of the modern(and old) Ruby language.
...
modules are introduced in [about_modules.md](./about_modules.rb), <em>etc</em>.  They are presented in
